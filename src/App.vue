      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
        ...
        <div class="py-4 text-left px-6">
          ...
          <form >
            <!-- Email -->
            <div class="mb-3">
              <label class="inline-block mb-2"   for="Email">Email
              <input type="email"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded"
                placeholder="Enter Email"  name="input_name" /></label>
            </div>
            <!-- Password -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="Password">Password
              <input type="password"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded"
          ...
          <form>
            <!-- Name -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="Name">Name
              <input type="text"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded"
            ...
            <!-- Age -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="Age">Age
              <input type="number"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
            ...
            <!-- Confirm Password -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="Confirm Password">Confirm Password
              <input type="password"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded"
            ...
            <!-- Country -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="Country">Country
              <select
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded">
            ...
            <!-- TOS -->
            <div class="mb-3 pl-6">
                  <label class="inline-block" for="Accept terms of service">Accept terms of service
